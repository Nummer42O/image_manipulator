...
namespace image_proc {
    ...
    const std::array<const char*, NR_COLOR_SPACES> color_space_names {
        "RGB",
        "GRAY",                     "BGR",                      "XYZ",                      "YCrCb",                    "Lab",
        "Luv",                      "HSV",                      "HLS",                      "YUV",                      "YUV_I420",
        "YUV_YV12",
    };
    const std::array<const std::array<const char*, NR_CHANNELS>, NR_COLOR_SPACES> color_space_channels{{
        {{" R ", " G ", " B "}},
